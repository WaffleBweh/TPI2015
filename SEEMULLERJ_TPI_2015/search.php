...
if (filter_input(INPUT_GET, 'querryKW')) {
    $querry = filter_input(INPUT_GET, 'querryKW');
    $keywordQuerry = true;
} else {
    $querry = filter_input(INPUT_GET, 'querry');
    $keywordQuerry = false;
}
?>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="well">
                    <ul class="media-list">
                        <?php
                        if ($keywordQuerry) {
                            echo structSearchedProductsKeywords($querry);
                        } else {
                            echo structSearchedProducts($querry);
                        }
                        ?>
                    </ul>
                </div>
